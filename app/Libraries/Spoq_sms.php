...
class SpoQ_sms {
	...
	public function __construct($initVar) {
		...
		*/
		...
		try {
			if ( !isset($initVar['event_name'])) throw new Exception('event_name 이 정의되지 않았습니다.');
		...
		$this->_set_msg($initVar['event_name']);
	...
	public function sendSms()
	{
		...
		$sms['user_id'] = base64_encode('techno137m'); //SMS 아이디.
		$sms['secure'] = base64_encode('f90a2ba66405c5ee0b486020a8b94ab9') ;//인증키
