...
namespace App\Libraries;
	...
	class StdPayUtil	{
		public function getTimestamp()	{
			...
			// 웰컴페이먼츠 플로우에서 timestamp 값이 중요하게 사용되는 것으로 보이기 때문에 정확한 timezone 설정후 timestamp 값이 필요하지 않을까 함.
		...
		public function makeHash($data, $alg) {
		...
		//결제보안 추가 인증.
		public function makeSignatureAuth($parameters) {
