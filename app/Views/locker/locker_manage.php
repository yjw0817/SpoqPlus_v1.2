...
<script>
// 새로운 앱 타입 시스템
window.LockerAppType = 'locker-management';
...
<?php if(ENVIRONMENT === 'development'): ?>
<script>
console.log('[Locker4 Debug] Page loaded - Management');
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    setTimeout(() => {
        if (appElement && appElement.children.length > 0) {
            ...
            console.log('[Locker4 Debug] Checking window.LockerAppType:', window.LockerAppType);
