	...
	<div class="container-fluid">
        ...
        <div class="row" id='status-info'>
            <div class="col-lg-3 col-6">
                ...
                <div class="inner">
                <h3><span style='font-size:25px;'><?php echo number_format($topinfo['get1'])?></span><sup style="font-size: 20px">회</sup></h3>
                <p>당월 수업전체 횟수</p>
                </div>
                <div class="icon">
			...
			<div class="col-md-12">
                ...
                <div class="card card-primary">
    				...
    				<div class="page-header">
    					<h3 class="panel-title">GX수업현황</h3>
    				</div>
    				<!-- CARD HEADER [END] -->
    	...
    	<div class="col_md-12" style='width:100%'>
    		<div class="" id="bottom-menu-area">
    			<form name="form_tmem_payment" id="form_tmem_payment" method="post" action="/api/tmem_gxlist">
                    ...
                    <br />
                    <div class='bottom-title text-center'>GX수업현황 검색</div>
