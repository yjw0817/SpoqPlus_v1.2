...
<section class="content">
	<div class="container-fluid">
    	...
    	<div class="row">
    		<div class="col-md-12 card card-olive">
    			<div class="page-header">
					<h3 class="panel-title" style='margin-top:5px;'>메모 정보</h3>
					<div style="text-align:right">
    				...
    				<div class='row p-3'>
    					...
    					<?php foreach ($attd_list as $a) : ?>
    						...
    						<?php if($a['ATTD_YN'] == "Y") : ?>
    							...
    							<div class='col-6 attd-div'><div class='attd-text'><small class="badge attd-num"></small><small class="badge bg-success bd-fsize"><i class="far fa-clock"></i>정</small> <span style="<?php echo $auto_chk?>;font-size:0.9rem;"><?php echo substr($a['CRE_DATETM'],0,16)?></span></div></div>
    						<?php else : ?>
    							<div class='col-6 attd-div'><div class='attd-text'><small class="badge attd-num"></small><small class="badge bg-warning bd-fsize"><i class="far fa-clock"></i>재</small> <span style="font-size:0.9rem;"><?php echo substr($a['CRE_DATETM'],0,16)?></span></div></div>
    						<?php endif; ?>
    					<?php endforeach; ?>
            		...
            		<div class="row">
            			<div class="col-md-12">
                            ...
                            <div class="card card-info">
                				...
                				<!-- CARD HEADER [START] -->
                				<div class="page-header">
                					<h3 class="panel-title">예약 상품 현황</h3>
                				</div>
                				<!-- CARD HEADER [END] -->
            		...
            		<div class="row" style='margin-top:20px'>
            			<div class="col-md-12">
                            ...
                            <div class="card card-primary">
                				...
                				<!-- CARD HEADER [START] -->
                				<div class="page-header">
                					<h3 class="panel-title">이용 상품 현황</h3>
                				</div>
                				<!-- CARD HEADER [END] -->
            		...
            		<div class="row" style='margin-top:20px'>
            			<div class="col-md-12">
                            ...
                            <div class="card card-danger">
                				...
                				<!-- CARD HEADER [START] -->
                				<div class="page-header">
                					<h3 class="panel-title">종료 상품 현황</h3>
                				</div>
                				<!-- CARD HEADER [END] -->
