			...
			<div class="col-md-12">
                ...
                <div class="card card-primary">
    				...
    				<div class="page-header">
    					<h3 class="panel-title">수업 상품 현황</h3>
    				</div>
    				<!-- CARD HEADER [END] -->
                            ...
                            <li class="item">
                                ...
                                <span class="product-description">
                                	...
                                	<span style='float:right'>
                                    	<button type="button" class="btn btn-xs bottom-menu" onclick="pt_chk('<?php echo $r['BUY_EVENT_SNO']?>');"><i class="fas fa-chevron-right"></i></button>
                                    </span>
                                </span>
