	...
	<div class="container-fluid">
		...
		<div class="row" id='status-info'>
            <div class="col-lg-4 p-1">
                <div class="small-box bg-info m5" >
                <div class="inner">
                <h3><?php echo $topinfo['get1']?><sup style="font-size: 20px">명</sup></h3>
                <p style="font-size: 14px">수업회원출석</p>
                </div>
                <div class="icon">
            ...
            <div class="col-lg-4 p-1">
                <div class="small-box bg-teal m5">
                <div class="inner">
                <h3><?php echo $topinfo['get2']?><sup style="font-size: 20px">회</sup></h3>
                <p style="font-size: 14px">오늘 수업수</p>
                </div>
                <div class="icon">
            ...
            <div class="col-lg-4 p-1">
                <div class="small-box bg-danger m5" >
                <div class="inner">
                <h3><?php echo $topinfo['get3']?><sup style="font-size: 20px">건</sup></h3>
                <p style="font-size: 14px">수업종료예정</p>
                </div>
                <div class="icon">
                <i class="ion ion-stats-bars"></i>
                </div>
...
.card-box {
    ...
    border:1px solid #ccc;
        ...
        <div class="row">	
        <div class="card-box01 bg-dark">
		<div class="row">			
        
            <div class="col-sm-4 col-12" onclick="location.href='/api/tsalary';">
                <div class="description-block ">
                <!-- <span class="description-percentage text-danger"><i class="fas fa-caret-up"></i> 17%</span> -->
                <h5 class="description-header"><?php echo number_format($midinfo['get1'])?> 원</h5>
                <span class="description-text">이번달 수당집계</span>
                </div>
            </div>
            
            <div class="col-sm-4 col-6" onclick="location.href='/api/tmem_payment';">
                <div class="description-block border-right">
                <!-- <span class="description-percentage text-danger"><i class="fas fa-caret-up"></i> 17%</span> -->
                <h5 class="description-header"><?php echo number_format($midinfo['get2'])?> 원</h5>
                <span class="description-text">판매금액</span>
                </div>
            </div>
            
            <div class="col-sm-4 col-6" onclick="location.href='/api/tmem_attdmemlist';">
                <div class="description-block">
                <!-- <span class="description-percentage text-danger"><i class="fas fa-caret-up"></i> 17%</span> -->
                <h5 class="description-header"><?php echo number_format($midinfo['get3'])?> 원</h5>
			...
			<div class="col-md-12">
                ...
                <div class="card-box">
					...
					<div class="page-header">
    					<h3 class="panel-title">강사 공지사항</h3>
    				</div>
					<!-- CARD HEADER [END] -->
                ...
                <div class="card-box">
					<!-- CARD HEADER [START] -->
					<div class="page-header">
    					<h3 class="panel-title ">회원 공지사항</h3>
    				</div>
					<!-- CARD HEADER [END] -->
		...
		<div class="row">
			<div class="col-md-12">
                ...
                <div class="card-box">
					<!-- CARD HEADER [START] -->
					<div class="page-header">
    					<h3 class="panel-title ">나의 오늘 GX 스케쥴</h3>
    				</div>
					<!-- CARD HEADER [END] -->
	...
	jQuery.ajax({
        ...
        success: function (result) {
			...
			if (json_result['result'] == 'true')
			{
                ...
                var addHtml = "";				
                addHtml = "<div class='bottom-title text-center'>강사 공지 상세</div>";
	...
	jQuery.ajax({
        ...
        success: function (result) {
			...
			if (json_result['result'] == 'true')
			{
                ...
                var addHtml = "";				
                addHtml = "<div class='bottom-title text-center'>회원 공지 상세</div>";
                addHtml += "<div class='col-12' style='padding:20px'>";
                addHtml += "   <p class='lead'>"+ obj['NOTI_TITLE'] +"</p>";
                addHtml += "   <div class='table-responsive'>";
                addHtml += "    <table class='table'>";
