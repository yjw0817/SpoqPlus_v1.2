	...
	<div class="container-fluid">
        ...
        <div class="row" id='status-info'>
            <div class="col-lg-3 col-4">
                ...
                <div class="inner">
                <h3>3<sup style="font-size: 20px">개</sup></h3>
                <p>예약상품</p>
                </div>
                <div class="icon">
			...
			<div class="col-md-12">
                ...
                <div class="card card-info">
    				...
    				<div class="page-header">
    					<h3 class="panel-title">보낼상품 현황</h3>
    				</div>
    				<!-- CARD HEADER [END] -->
                    ...
                    <div class="panel-body p-0">
                        <ul class="products-list product-list-in-card pl-2 pr-2">
                            <li class="item">
                                <div class="product-img" style='border-radius:6px;padding:3px;width:45px;margin-top:20px;'>
                                	<div class="icheck-primary d-inline" style="margin-left:10px;">
                                        <input type="checkbox" name="send_chk[]" id="aaa1" value="" />
                                        <label for="aaa1">
                                        	<small></small>
                                        </label>
                                    </div>
                                ...
                                <a href="javascript:void(0)" class="product-title">
                                	<span class="badge bg-success">입장무제한</span>
                                	헬스
                                	<!-- <span class="badge float-right" style="text-decoration: line-through;color:red">300,000</span>  -->
                                </a>
                                <span class="product-description">
                                	헬스 3개월
                                	<span style="font-size:0.8rem;color:green">(이순신 4571)</span>
                                	<span class="badge bg-info float-right">250,000</span>
                                </span>
                            ...
                            <li class="item">
                                <div class="product-img" style='border-radius:6px;padding:3px;width:45px;margin-top:20px;'>
                                	<div class="icheck-primary d-inline" style="margin-left:10px;">
                                        <input type="checkbox" name="send_chk[]" id="aaa2" value="" />
                                        <label for="aaa2">
                                        	<small></small>
                                        </label>
                                    </div>
                                ...
                                <div class="product-info">
                                <a href="javascript:void(0)" class="product-title">
                                	<span class="badge bg-success">수업입장</span>
                                	PT
                                ...
                                <span class="product-description">
                                	PT 10회
                                	<span style="font-size:0.8rem;color:green">(이순신 4571)</span>
                                	<span class="badge bg-info float-right">1,000,000</span>
                                </span>
                                <span style="font-size:0.8rem;color:green">
                                3회 이용중
                                </span>
                            ...
                            <li class="item">
                                <div class="product-img" style='border-radius:6px;padding:3px;width:45px;margin-top:20px;'>
                                	<div class="icheck-primary d-inline" style="margin-left:10px;">
                                        <input type="checkbox" name="send_chk[]" id="aaa3" value="" />
                                        <label for="aaa3">
                                        	<small></small>
                                        </label>
                                    </div>
                                ...
                                <div class="product-info">
                                	<a href="javascript:void(0)" class="product-title">
                                    <span class="badge bg-danger">입장불가</span>
                                    락커
                                    </a>
                                <span class="product-description">
                                	락커 3개월
                                	<span style="font-size:0.8rem;color:green">(이순신 4571)</span>
                                	<span class="badge bg-info float-right">30,000</span>
                                </span>
                                <span style="font-size:0.8rem;color:green">
                                2024-05-01 ~ 2024-08-01
                                </span>
