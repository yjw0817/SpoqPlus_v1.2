			...
			<div class="col-md-12">
                ...
                <div class="card card-primary">
    				...
    				<div class="page-header">
    					<h3 class="panel-title">GX 수업진행내역</h3>
    				</div>
    				<!-- CARD HEADER [END] -->
    			
                    <div class="panel-body p-0">
                        <ul class="products-list product-list-in-card pl-2 pr-2">
                            <?php foreach ($detail_sarly['sarly_mgmt'][0]['detail'] as $r) :
                                $item_color = "black";
                                $item_word = "";
                            ?>
                            <li class="item">
                                ...
                                <a href="javascript:void(0)" class="product-title" style='color:<?php echo $item_color?>'>
                                	<?php echo $r['GX_CLAS_TITLE']?> <?php echo $item_word?>
                                ...
                                <span class="product-description">
                                	...
                                	<span style='float:right'>
                                    	<button type="button" class="btn btn-xs" ><i class="fas fa-chevron-right"></i></button>
                                    </span>
                                     -->
                                </span>
                                <span class="float-left" style="font-size:0.8rem;color:green">
                                <?php echo $r['GX_CLAS_DATE']?> |  <?php echo $r['GX_CLAS_S_HH_II']?> ~ <?php echo $r['GX_CLAS_E_HH_II']?>  
                                </span>
