...
<section class="content">
	<div class="container-fluid">
		...
		<div class="row" style='margin-top:20px'>
			<div class="col-md-12">
				<div style='color:red;font-size:0.8rem;'>* 이용권 종료 예정은 이번달 말일까지 입니다.</div>
				<div style='color:red;font-size:0.8rem;'>* 수업종료 예정은 남은 수업일이 6회 이하일 경우입니다.</div>
			</div>
		</div>
			...
			<div class="col-md-12">
                ...
                <div class="card card-primary">
    				...
    				<div class="page-header">
    					<h3 class="panel-title">종료 예정 수업 상품 현황</h3>
    				</div>
    				<!-- CARD HEADER [END] -->
				...
				<div class="card card-primary">
    				...
    				<!-- CARD HEADER [START] -->
    				<div class="page-header">
    					<h3 class="panel-title">종료 예정 이용권 상품 현황</h3>
    				</div>
    				<!-- CARD HEADER [END] -->
