		...
		<div class="row">
			<div class="col-md-12">
				...
				<?php foreach ($list_notice as $r) :?>
                    <strong><i class="fas fa-circle"></i> <?php echo $r['NOTI_TITLE']?></strong>
                    ...
                    <span style="font-size:0.8rem;"><strong><i class="far fa-calendar-alt"></i> <?php echo $r['CRE_DATETM']?></strong></span>
                    <hr>
                <?php endforeach;?>
