    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-blue btn-sm" id="btnSave">저장하기</button>
...
<script>
	...
	function fnMenuTreeList(seq_role){
		...
		$.ajax({
			type: 'POST',
			url: '/rolemanage/getMenuTreeListWithRole',
    		dataType:'json',
    		data:JSON.stringify(tblParam),
    		contentType:'application/json; charset=utf-8',
			async : false,
	...
	function fnSaveRoleMenu() {
		...
		var url = '/rolemanage/saveRoleMenu';
