...
<div class="panel panel-inverse">
	<div class="panel-heading">
		<h4 class="panel-title">회원 공지사항 리스트</h4>
	</div>
	<!-- CARD HEADER [END] -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-lightblue">
                <h5 class="modal-title">회원 공지사항 등록하기</h5>
            ...
            <div class="modal-body">
            	...
            	<input type="hidden" name="noti_dv" id="noti_dv" value="01" />
                ...
                <div class="input-group input-group-sm mb-1">
                	<span class="input-group-append">
                		<span class="input-group-text" style='width:100px'>공지 시작일</span>
                	</span>
...
<div class="modal fade" id="modal_notice_modify_form">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-lightblue">
                <h5 class="modal-title">회원 공지사항 수정하기</h5>
                <button type="button" class="close2"  data-bs-dismiss="modal" aria-label="Close">
                <i class="fas fa-times" style="font-size:18px;"></i>
                </button>
            </div>
            <div class="modal-body">
            	...
            	<input type="hidden" name="mod_noti_dv" id="mod_noti_dv" value="01" />
                <div class="input-group input-group-sm mb-1">
                	<span class="input-group-append">
                		<span class="input-group-text" style='width:100px'>제목</span>
                	</span>
...
{
	var params = "noti_sno="+noti_sno+"&noti_dv=01";
    jQuery.ajax({
