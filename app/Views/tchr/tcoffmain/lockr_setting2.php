...
<section class="content">
	<div class="container-fluid">
		<div class=" col-xs-12 mt20">
			<h1 class="page-header">골프 락커(사물함) 설정</h1></div>
		<div class="row">
			<div class="col_md-12" style='margin-bottom:10px;'>
				<button type="button" class="btn btn-default3"  onclick="location.href='/tbcoffmain/locker_setting';">락커 설정</button>
				<button type="button" class="btn btn-blue"  onclick="location.href='/tbcoffmain/locker_setting2';">골프라커 설정</button>
			</div>
		</div>
...
<div class=" col-xs-12  col-md-6 col-lg-4  panel2 panel-inverse">
	...
	<div class="panel-body table-responsive">
					...
					<input type="hidden" name="lockr_knd" value="02" />
						...
						<table class="table table-bordered col-md-12">
							...
							<?php foreach($lockr_list['m01'] as $r) : ?>
								<tr class="text-center">
									...
									<td>
										<button type="button" class="btn btn-danger btn-xs" style='margin-left:10px' onclick="lockr_del('02','M','<?php echo $r['LOCKR_S_NO']?>','<?php echo $r['LOCKR_E_NO']?>','<?php echo $r['LOCKR_SET_HIST_SNO']?>');">삭제하기</button>
									</td>
								</tr>
							<?php endforeach; ?>
							</tbody>
						...
						<table class="table table-bordered col-md-12">
							...
							<?php foreach($lockr_list['f01'] as $r) : ?>
								<tr class="text-center">
									...
									<td><?php echo $r['LOCKR_E_NO'] ?></td>
									<td>
										<button type="button" class="btn btn-danger btn-xs" style='margin-left:10px' onclick="lockr_del('02','F','<?php echo $r['LOCKR_S_NO']?>','<?php echo $r['LOCKR_E_NO']?>','<?php echo $r['LOCKR_SET_HIST_SNO']?>');">삭제하기</button>
									</td>
								</tr>
							<?php endforeach; ?>
							</tbody>
						...
						<table class="table table-bordered col-md-12">
							...
							<?php foreach($lockr_list['g01'] as $r) : ?>
								<tr class="text-center">
									...
									<td><?php echo $r['LOCKR_E_NO'] ?></td>
									<td>
										<button type="button" class="btn btn-danger btn-xs" style='margin-left:10px' onclick="lockr_del('02','G','<?php echo $r['LOCKR_S_NO']?>','<?php echo $r['LOCKR_E_NO']?>','<?php echo $r['LOCKR_SET_HIST_SNO']?>');">삭제하기</button>
									</td>
								</tr>
							<?php endforeach; ?>
							</tbody>
