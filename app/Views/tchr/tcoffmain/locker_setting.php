...
<section class="content">
	<div class="container-fluid">
		<div class=" col-xs-12 mt20"><h1 class="page-header">락커(사물함) 설정</h1></div>
		<div class="row">
			<div class="col_md-12" style='margin-bottom:10px;'>
				<button type="button" class="btn btn-blue"  onclick="location.href='/tbcoffmain/locker_setting';">락커 설정</button>
				<button type="button" class="btn btn-default3"  onclick="location.href='/tbcoffmain/locker_setting2';">골프라커 설정</button>
			</div>
		</div>
