		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<div class="card card-danger">
					<!-- CARD HEADER [START] -->
					<div class="page-header">
						<h3 class="panel-title">미수금 상품 정보</h3>
					</div>
					<!-- CARD HEADER [END] -->
...
<div class="row">
	<div class="col-md-3">						
        ...
        <div class="input-group input-group-sm mb-1">
        	<span class="input-group-append">
        		<span class="input-group-text" style='width:150px'>구매금액</span>
        	</span>
        	<input type="text" class="input-readonly" style='width:140px; margin-left:5px' placeholder="" name="sell_amt" id="sell_amt" value="<?php echo number_format($event_info['REAL_SELL_AMT'])?>" readonly />
        </div>
        <!-- [판매금액] [END] -->
        <!-- [실제 판매할 금액] [START] -->
        <div class="input-group input-group-sm mb-1">
        	...
        	<input type="text" class="input-readonly" style='width:140px; margin-left:5px' placeholder="" name="buy_amt" id="buy_amt"  value="<?php echo number_format($event_info['BUY_AMT'])?>" readonly />
        </div>
        <!-- [실제 판매할 금액] [START] -->
        <div class="input-group input-group-sm mb-1">
        	<span class="input-group-append">
        		<span class="input-group-text" style='width:150px'>남은 미수금액</span>
        	</span>
        	<input type="text" class="input-readonly" style='width:140px; margin-left:5px' placeholder="" name="recvb_amt" id="recvb_amt"  value="<?php echo number_format($event_info['RECVB_AMT'])?>" readonly />
        </div>
        <!-- [실제 판매할 금액] [END] -->
	...
	<div class="col-md-6">
        ...
        <div class="input-group input-group-sm mb-1">
        	...
        	<input type="text" class="" style='width:100px; margin-left:5px' placeholder="" name="card_amt" id="card_amt"  value="" />
        	<!-- 
        	<span class="input-group-append">
        ...
        <div class="input-group input-group-sm mb-1">
        	...
        	<input type="text" class="" style='width:100px; margin-left:5px' placeholder="" name="cash_amt" id="cash_amt"  value="" />
        </div>
        <!-- [현금결제] [END] -->
        <!-- [미수금] -->
        <div class="input-group input-group-sm mb-1">
        ...
        <!-- [계좌이체] [END] -->
					...
					<div class="card-footer clearfix">
                        ...
                        <ul class="pagination pagination-sm m-0 float-left">
							...
							<?php else: ?>
							<li class="ac-btn"><button type="button" class="btn btn-block btn-info btn-sm" onclick="location.href='/teventmain/event_buy/<?php echo $mem_info['MEM_SNO']?>';">상품구매로 가기</button></li>
							<?php endif; ?>
                        </ul>
                        <!-- BUTTON [END] -->
						<!-- BUTTON [START] -->
						<ul class="pagination pagination-sm m-0 float-right">
							<li class="ac-btn"><button type="button" class="btn btn-block btn-success btn-sm" id='btn_pay_confirm'>미수금 결제완료</button></li>
						</ul>
...
<form name="form_payment_submit" id="form_payment_submit" method="post" action="/teventmain/misu_manage_proc">
...
$('#btn_pay_confirm').click(function(){
	...
	if(($('#card_amt').val() == '' || $('#card_amt').val() == 0) && ($('#cash_amt').val() == '' || $('#cash_amt').val() == 0))
	{
		alertToast('error','입금액을 입력하세요.');
		return;
	}
	if ( $('#misu_amt').val() != '' )
	{
	...
	if ( $('#card_amt').val() != "" )
	{
		...
		{
			alertToast('error','카드결제금액이 있습니다. 결제 또는 수동결제 버튼을 클릭하세요');
			return;
		}
	}
