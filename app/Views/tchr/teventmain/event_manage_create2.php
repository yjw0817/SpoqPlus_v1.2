...
<div id="content"  class="app-content">
	...
	<div class="row">
		...
		<div class="col-xl-8" id="bsSpyContent">
			...
			<!-- BEGIN #select_cate -->
			<div id="select_cate" class="mb-4 pb-3">
						...
						<div class="list-group-item d-flex align-items-center">
							<div class="flex-fill me-4"> <!-- 첫 번째 flex-fill에 오른쪽 마진 추가 -->
								...
								<div class="text-body text-opacity-60">
									<select class="form-select use-per-day-select-width" style="width: 150px;" name="1rd_cate_cd" id="1rd_cate_cd" >
                                		<option value=''>대분류 선택</option>
                                		<?php foreach($cate1 as $c1) :?>
                                			<option value="<?php echo $c1['1RD_CATE_CD']?>" 													
											data-grp-cate-set="<?php echo $c1["GRP_CATE_SET"]; ?>"><?php echo $c1['CATE_NM']?></option>
                                		<?php endforeach;?>
                					</select>
								</div>
							</div>
							<div class="flex-fill me-4"> <!-- 두 번째 flex-fill에 오른쪽 마진 추가 -->
								...
								<div class="d-flex align-items-center text-body text-opacity-60">
									<select class="form-select use-per-day-select-width me-3" style="width: 250px;" name="2rd_cate_cd" id="2rd_cate_cd">
			...
			<div id="general" class="mb-4 pb-3">
				<h4 class="d-flex align-items-center mb-2">
					<iconify-icon class="fs-24px me-2 text-body text-opacity-75 my-n1" icon="solar:winrar-bold-duotone"></iconify-icon> 이용권그룹 선택
				</h4>
												...
												<select class="form-select event-group-select-width" id="select-required-1" name="prev_event_group">
													...
													<?php foreach ($event_list as $r) : ?>
														<option value="<?php echo $r["SELL_EVENT_SNO"]; ?>"
																...
																data-1rd-cate-cd="<?php echo $r["1RD_CATE_CD"]; ?>"
