			...
			<div class="col-md-12">
				<div class="panel panel-inverse">
					<div class="panel-heading">
						<h4 class="panel-title">골프라커 관리</h4>
					</div>

                   <div class=" clearfix" style='padding:10px;'>
					<div class="row">
						<div class="col_md-12" style='margin-bottom:10px; margin-top:5px;'>
							<button type="button" class="btn btn-default3"  onclick="location.href='/teventmain/lockr_manage';">락커 설정</button>
							<button type="button" class="btn btn-blue"  onclick="location.href='/teventmain/lockr_manage2';">골프라커 설정</button>
						</div>
					</div>
						...
						<ul class="card-footer pagination pagination-sm m-0 ">
							<li class="ac-btn"><a href="/teventmain/lockr_manage2/<?php echo $lockr_inf['lockr_knd']?>/M" class="btn btn-block btn-default size13 mr5 <?php echo $btn_class['M']?> btn-sm">남자</a></li>
							<li class="ac-btn"><a href="/teventmain/lockr_manage2/<?php echo $lockr_inf['lockr_knd']?>/F" class="btn btn-block btn-default size13  <?php echo $btn_class['F']?> btn-sm">여자</a></li>
							<li class="ac-btn"><a href="/teventmain/lockr_manage2/<?php echo $lockr_inf['lockr_knd']?>/G" class="btn btn-block btn-default size13 ml5 <?php echo $btn_class['G']?> btn-sm">공용</a></li>
						</ul>
					...
					<div class="panel-body card-footer">
						<div class="row">
							<div class="col-md-12">
								...
								?>
								<a href="/teventmain/lockr_manage2/<?php echo $lockr_inf['lockr_knd']?>/<?php echo $lockr_inf['gendr']?>/<?php echo $room_i?>" class="btn btn-block <?php echo $btn_range_class?> btn-sm"><?php echo $r['min']?>~<?php echo $r['max']?> [<?php echo $r['poss_cnt'] ?>] 개 사용가능 </a>
								<?php
									$room_i++;
									endforeach; 
								?>
