...
<section class="content">
	...
	<form name="event_create_form" id="event_create_form" method="post" action="/teventmain/create_event_proc">
		<input type="hidden" name="clas_dv" id="clas_dv" />
		<input type="hidden" name="sell_event_sno_base" value="" />
		<input type="hidden" name="event_step" value="1" />
			...
			<div class="col-md-9">
				<div class="card card-primary">
					...
					<div class="page-header">
						<h5 class="panel-title" style="font-size: 1.0rem !important;">분류 선택 (대분류,중분류를 선택하시면 나머지 입력 화면이 표시 됩니다.)</h5>
					</div>
					<!-- CARD HEADER [END] -->
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="input-group input-group-sm mb-1">
                                	<span class="input-group-append">
                                		<span class="input-group-text" style='width:150px'>대분류 선택</span>
                                	</span>
                                	<select class="select2 form-control" style="width: 150px;" name="1rd_cate_cd" id="1rd_cate_cd" onChange="cate1_ch();">
                                		<option>대분류 선택</option>
                                		<?php foreach($cate1 as $c1) :?>
                                			<option value="<?php echo $c1['1RD_CATE_CD']?>"><?php echo $c1['CATE_NM']?></option>
                                		<?php endforeach;?>
                					</select>
                                </div>
								<!-- [대분류 선택] [END] -->
							...
							<div class="col-md-6">
								...
								<div class="input-group input-group-sm mb-1">
                                	...
                                	<select class="select2 form-control" style="width: 250px;" name="2rd_cate_cd" id="2rd_cate_cd">
		...
		<div class="row" id="disp1" style="display:none">
			<div class="col-md-9">
				<div class="card">
					<!-- CARD BODY [START] -->
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
    							...
    							<div class="input-group input-group-sm mb-1">
                                	...
                                	<input type="text" class="form-control" style='width:140px; margin-left:5px' placeholder="" name="sell_event_nm" id="sell_event_nm" autocomplete='off' >
                                </div>
    							<!-- [판매금액] [END] -->
    						</div>
    					</div>
						...
						<div class="row">
							<div class="col-md-4" id="disp_prod">
								<!-- [이용기간] [START] -->
								<div class="input-group input-group-sm mb-1">
                                	<span class="input-group-append">
		...
		<div class="row" id="disp2" style="display:none">
			<div class="col-md-9">
				<div class="card">
					<!-- CARD HEADER [START] -->
					<div class="page-header">
					...
					<!-- CARD BODY [START] -->
					<div class="panel-body" id="disp_domcy">
						...
						<div class="row">
							<div class="col-md-4">
								...
								<div class="input-group input-group-sm mb-1">
                                	<span class="input-group-append">
                                		<span class="input-group-text" style='width:150px'>휴회횟수</span>
                                	</span>
		...
		<div class="row" id="disp3" style="display:none">
			<div class="col-md-9">
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="input-group input-group-sm mb-1">
                                	...
                                	<div style='margin-top:4px;margin-left:5px;' class="pt_no">
                                    	<div class="icheck-primary d-inline" id="disp_rtrct_dv_00">
                                            <input type="radio" id="acc_rtrct_dv_00" name="acc_rtrct_dv" value="00" checked>
                                        ...
                                        <div class="icheck-primary d-inline">
                                         ...
                                         -->
                                        <div class="icheck-primary d-inline" id="disp_rtrct_dv_99">
                                    ...
                                    <div style='margin-top:4px;margin-left:5px;display:none' class="pt_yes">
                                    	<div class="icheck-primary d-inline" id="disp_rtrct_dv_50">
                                            <input type="radio" id="acc_rtrct_dv_50" name="acc_rtrct_dv" value="50">
								...
								<div class="input-group input-group-sm mb-1">
                                	...
                                	<div style='margin-top:4px;margin-left:5px;' class="pt_no">
                                    	<div class="icheck-primary d-inline" id="disp_rtrct_mthd_00">
                                            <input type="radio" id="acc_rtrct_mthd_00" name="acc_rtrct_mthd" value="00" checked readonly>
                                        ...
                                        <div class="icheck-primary d-inline">
                                         ...
                                         -->
                                        <div class="icheck-primary d-inline" id="disp_rtrct_mthd_99">
                                    ...
                                    <div style='margin-top:4px;margin-left:5px;display:none' class="pt_yes">
                                    	<div class="icheck-primary d-inline" id="disp_rtrct_mthd_00">
                                            <input type="radio" id="acc_rtrct_mthd_50" name="acc_rtrct_mthd" value="50" >
		...
		<div class="row" id="disp4" style="display:none">
			<div class="col-md-9">
...
$('#create_event_btn').click(function(){
	...
	if ( $('#sell_event_nm').val() == '' )
	{
		alertToast('error','판매 상품명을 입력하세요');
		$('#sell_event_nm').focus();
		return;
	}
...
$("#2rd_cate_cd").on("change", function () {
    ...
    switch(clas_dv)
	{
		case 11 : // 중분류 
			...
			$('#acc_rtrct_dv_00').prop('checked',true);
			$('#acc_rtrct_mthd_00').prop('checked',true);
			
			$('#domcy_poss_event_yn_y').trigger('click');
		...
		case 21 : // PT 
			...
			$('#acc_rtrct_dv_50').prop('checked',true);
			$('#acc_rtrct_mthd_50').prop('checked',true);
			
			$('#domcy_poss_event_yn_n').trigger('click');
			$('#domcy_poss_event_yn_y').attr('disabled',true);
