...
<section class="content">
	...
	<form name="event_create_form" id="event_create_form" method="post" action="/teventmain/create_event_proc">
		...
		<input type="hidden" name="event_depth" value="3" />
		<input type="hidden" name="event_acc_ref_sno" value="<?php echo $einfo['event_acc_ref_sno']?>" />
		<div class="row">
			<div class="col-md-9">
						...
						<div class="row">
							<div class="col-md-4">
								...
								<div class="input-group input-group-sm mb-1">
                                	<span class="input-group-append">
                                		<?php
                                		$disp_prod_text = "이용기간";
                                		if($einfo['clas_dv'] == "21" || $einfo['clas_dv'] == '22') $disp_prod_text = "무료이용기간";
                                		?>
                                		<span class="input-group-text" style='width:150px' id="title_use_prod"><?php echo $disp_prod_text?></span>
                                	</span>
                                	<input type="text" class="" style='width:80px; margin-left:5px;background-color:#eeeeee;' placeholder="" name="use_prod" id="use_prod" value="<?php echo $einfo['use_prod']?>" readonly autocomplete='off' maxlength="3">
                                	...
                                	<div style='margin-top:4px;margin-left:5px;'>
                                    	...
                                    	?>
                                    	<input type="hidden" name="use_unit" value="<?php echo $einfo['use_unit']?>" />
                                    	<!-- 
                                    	<div class="icheck-primary d-inline">
                                            <input type="radio" name="use_unit" id="use_unit_m" value="M" <?php if($einfo['use_unit'] == "M") {?>checked<?php }?> >
                                            <label for="use_unit_m">
                                            	<small>개월</small>
                                            </label>
                                        </div>
                                        <div class="icheck-primary d-inline">
                                            <input type="radio" name="use_unit" id="use_unit_d" value="D" <?php if($einfo['use_unit'] == "D") {?>checked<?php }?> >
							...
							<div class="col-md-4">
								...
								<div class="input-group input-group-sm mb-1">
                                	...
                                	<input type="text" class="" style='width:140px; margin-left:5px' placeholder="" name="sell_amt" id="sell_amt" value="<?php echo number_format($einfo['sell_amt'])?>" autocomplete='off'>
                                </div>
								<!-- [판매금액] [END] -->
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-4">
								...
								<div class="input-group input-group-sm mb-1">
                                	...
                                	<input type="text" class="" style='width:80px; margin-left:5px' placeholder="" name="domcy_cnt" id="domcy_cnt" value="<?php echo $einfo['domcy_cnt']?>" autocomplete='off' maxlength="3">
                                </div>
								<!-- [휴회횟수] [END] -->
							</div>
							<div class="col-md-4">
								...
								<div class="input-group input-group-sm mb-1">
                                	...
                                	<input type="text" class="" style='width:80px; margin-left:5px' placeholder="" name="domcy_day" id="domcy_day" value="<?php echo $einfo['domcy_day']?>" autocomplete='off' maxlength="3">
                                </div>
								<!-- [휴회일수] [END] -->
							</div>
						</div>
						...
						<div class="row">
								...
								<div class="input-group input-group-sm mb-1">
                                	...
                                	<div style='margin-top:4px;margin-left:5px;'>
                                    	...
                                    	<div class="icheck-primary d-inline">
                                         ...
                                         -->
                                        <div class="icheck-primary d-inline">
                                            <input type="radio" id="acc_rtrct_dv_01" name="acc_rtrct_dv" value="01" checked>
							...
							<div class="col-md-6">
								...
								<div class="input-group input-group-sm mb-1">
                                	...
                                	<div style='margin-top:4px;margin-left:5px;'>
                                    	<div class="icheck-primary d-inline">
                                            <input type="radio" id="acc_rtrct_mthd_00" name="acc_rtrct_mthd" value="00" checked>
