...
<section class="content">
   <div class="row">   
     <div class="new-title">※ 센터 입장 위한 QR 코드 입니다.</div>	
  </div>
		
		<div class="row">
			<div class="col-md-12">
				<div style='width:100%;text-align:center;'>
					<div id="qrcode" class='qrcode' style="margin:30px 0px;"></div>
				</div> 
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class='txt-l size15' style='margin:10px'>
...
<button type='button' class='btn btn-block height50 ft-white bga-main mt40 pad10 radius0' style="display:none !important;" onclick="temp_attd();">임시 출석</button>
