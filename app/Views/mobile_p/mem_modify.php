			...
			<div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-header">
                     ...
                     -->
                    <div class="card-body">
                    	<form id="form_tmodify" enctype="multipart/form-data">
                        <!-- 
                        ...
                        <div class="form-group">
                            <label for="inputName">회원 생년월일 <span class="text-danger">*</span></label>
                        ...
                        <button type="button" class='btn btn-block btn-info btn-sm p-3' onclick="tmem_modify();">회원정보 수정하기</button>
...
//           dataScaleY.value = typeof data.scaleY !== 'undefined' ? data.scaleY : '';
	...
	console.log('mem_photo success');
});


function tmem_upload()
{
	cropper.getCroppedCanvas().toBlob((blob) => {
      ...
      jQuery.ajax({
        ...
        success: function (result) {
			...
			{
				alertToast('success',json_result['path']);
			} else 
			{
				alertToast('error',json_result['path']);
			}
        }
    	});
      });
...
function tmem_modify()
{
    if ( $('#mem_nm').val() == '' )
    {
        alertToast('error','회원 이름을 입력해주세요.');
        return;
    }
    if ( $('#mem_telno').val() == '' )
    {
        alertToast('error','회원 전화번호를 입력해주세요.');
        return;
    }
    if ( $('#bthday').val() == '' )
    {
        alertToast('error','생년월일을 입력해주세요.');
        return;
    }
