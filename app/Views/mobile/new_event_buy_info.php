	...
	<div class="container-fluid">
		<div class="row">
            <div class="col-md-12">
            	...
            	<div class='a-title'>판매 상품 리스트</div>
            	
            	<div class="a-list">
                    <div class="a-item">
                    	<div class='a-item-sec item-bold'>
                    		상품명
                    		<span class="item-light ft-default"><?php echo $event_info['SELL_EVENT_NM']?></span>
                    	</div>
                    ...
                    <div class="a-item">
                    	<div class='a-item-sec item-bold'>
                    		입장종류
                    		<span class="item-light ft-default"><?php echo $sDef['ACC_RTRCT_DV'][$event_info['ACC_RTRCT_DV']]?></span>
                    	</div>
                    	<div class="a-item-line"></div>
                    </div>
                    <div class="a-item">
                    	<div class='a-item-sec item-bold'>
                    		입장상세
                    		<span class="item-light ft-default"><?php echo $sDef['ACC_RTRCT_MTHD'][$event_info['ACC_RTRCT_MTHD']]?></span>
                    	</div>
                    	<div class="a-item-line"></div>
                    </div>
                    <div class="a-item">
                    	<div class='a-item-sec item-bold'>
                    		이용개월
                    		<span class="item-light ft-default">
                    ...
                    <div class="a-item">
                    	<div class='a-item-sec item-bold'>
                    		휴회가능일
                    		<span class="item-light ft-default"><?php echo $event_info['DOMCY_DAY']?> 일</span>
                    	</div>
                    	<div class="a-item-line"></div>
                    </div>
                    <div class="a-item">
                    	<div class='a-item-sec item-bold'>
                    		휴회가능횟수
                    		<span class="item-light ft-default"><?php echo $event_info['DOMCY_CNT']?> 회</span>
                    	</div>
                    	<div class="a-item-line"></div>
                    </div>
                    <div class="a-item">
                    ...
                    <div class="a-item">
                    	<div class='a-item-sec item-bold'>
                    		판매강사
                    		<span class="item-light ft-default"><?php echo $event_info['PTCHR_NM']?></span>
                    	</div>
                    </div>
                    <?php endif; ?>	
		...
		<button type="button" class="btn btn-block btn-danger btn-sm" style='height:50px;' id="btn_pay_mobile">모바일 결제(연동)</button>
		 -->
		<button type="button" class="btn btn-block btn-sm" style='height:50px;background-color:#0698A9;color:#fff;' id='btn_pay_confirm'>결제 상품 확인</button>
