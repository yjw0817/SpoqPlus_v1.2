		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel-body">
                    ...
                    <?php
                    $disp_mem_stat = "";
                    if($r['MEM_STAT'] == 01) $disp_mem_stat="<span style='font-size:0.9rem;color:blue'>[이용중]</span>";
                    if($r['MEM_STAT'] == 90) $disp_mem_stat="<span style='font-size:0.9rem;color:red'>[종료됨]</span>";
                    
                    echo $disp_mem_stat;
                    ?>
                     <?php echo $r['BCOFF_NM']?></strong>
                    <p class="text-muted"><?php echo $r['BCOFF_ADDR']?> <br /> 상세주소
                        <span style='float:right'>
                        	<button type="button" class="btn btn-xs bottom-menu" onclick="setcomp('<?php echo $r['COMP_CD']?>','<?php echo $r['BCOFF_CD']?>');"><i class="fas fa-chevron-right"></i></button>
                        </span>
                    </p>
                    <strong><i class="fas fa-phone"></i> <?php echo disp_phone($r['BCOFF_TELNO'])?></strong>
                    <hr>
                    <?php endforeach;?>
