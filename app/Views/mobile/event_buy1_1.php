			...
			<div class="col-md-12">
                ...
                <div class="card card-info">
    				...
    				<div class="page-header">
    					<h3 class="panel-title">판매 상품 리스트</h3>
    				</div>
    				<!-- CARD HEADER [END] -->
                            ...
                            <li class="item">
                                ...
                                <a href="javascript:void(0)" class="product-title">
                                	...
                                	<span style='float:right'>
                                    	<button type="button" class="btn btn-xs" onclick="buy_info('<?php echo $r['SELL_EVENT_SNO']?>');"><i class="fas fa-chevron-right"></i></button>
                                    </span>
                                </a>
                                <span class="product-description" style='margin-top:5px;'>
                                	<span class="badge bg-info"><?php echo $sDef['ACC_RTRCT_DV'][$r['ACC_RTRCT_DV']]?></span>
