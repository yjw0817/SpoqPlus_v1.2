	...
	<div class="container-fluid">
        ...
        <div class="row" id='status-info'>
            <div class="col-lg-3 col-6">
                ...
                <div class="inner">
                <h3><?php echo count($list_send1)?><sup style="font-size: 20px">개</sup></h3>
                <p>추천상품</p>
                </div>
                <div class="icon">
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="inner">
                <h3><?php echo count($list_send2)?><sup style="font-size: 20px">개</sup></h3>
                <p>구매상품</p>
                </div>
                <div class="icon">
                ...
                <div class="card card-info">
                    ...
                    <div class="panel-body p-0">
                        <ul class="products-list product-list-in-card pl-2 pr-2">
                            ...
                            <?php endforeach; ?>
                            <?php else : ?>
                    			<li class="item" style='font-size:0.9rem;'>추천 상품이 없습니다.</li>
							<?php endif; ?>
                        </ul>
                    </div>
                    ...
                    <div class="panel-body p-0">
                        <ul class="products-list product-list-in-card pl-2 pr-2">
                            ...
                            <li class="item">
                                ...
                                <span style="font-size:0.8rem;color:red">
                                <?php echo $r['MOD_DATETM']?>에 구매함
                                </span>
                                </div>
                            </li>
                            <?php endforeach; ?>
                            <?php else : ?>
                    			<li class="item" style='font-size:0.9rem;'>구매한 추천 상품이 없습니다.</li>
							<?php endif; ?>
