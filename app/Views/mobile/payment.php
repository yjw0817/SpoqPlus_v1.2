	...
	<div class="container-fluid">
        ...
        <div class="row" id='status-info'>
            <div class="col-lg-3 col-6">
                ...
                <div class="inner">
                <h4>결제금액</h4>
                <h5><?php echo number_format($sum1[0]['sum_cost'])?>원</h5>
                </div>
                <div class="icon">
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="inner">
                <h4>환불금액</h4>
                <h5><?php echo number_format($sum2[0]['sum_cost'])?></h5>
                </div>
                <div class="icon">
                        ...
                        <ul class="products-list product-list-in-card pl-2 pr-2">
                            ...
                            <li class="item">
                                ...
                                <span class="product-description">
                                	<?php echo $sDef['SALES_DV_RSON'][$r['SALES_DV_RSON']]?>
                                	<span class="badge bg-info float-right"><?php echo number_format($r['PAYMT_AMT'])?></span>
                                </span>
                    ...
                    <div class="panel-body p-0">
                        <ul class="products-list product-list-in-card pl-2 pr-2">
                            ...
                            <li class="item">
                                ...
                                <span class="product-description">
                                	<?php echo $sDef['SALES_DV_RSON'][$r['SALES_DV_RSON']]?>
                                	<span class="badge bg-danger float-right"><?php echo number_format($r['PAYMT_AMT'])?></span>
                                </span>
