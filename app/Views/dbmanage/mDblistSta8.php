			...
			<div class="col-md-12">
				...
				<div class="card card-primary">
					<div class="page-header">
						<h3 class="panel-title">내원완료통계(이벤트별)</h3>
					</div>
					<div class="panel-body">
						
						<form name='stForm' id='stForm' method='post' action='/dbmanage/mDblistSta8'>
						...
						<table class="table table-bordered table-hover table-striped col-md-12">
							...
							?>
								<tr>
									...
									$temp_total = 0;
									for($i=1; $i<$day_count+1; $i++):
									$bottom_total[$i] += $dblist[$g['company_idx']][$g['event_idx']][sprintf('%02d', $i)];
									?>
									<td>
									<?php if ($dblist[$g['company_idx']][$g['event_idx']][sprintf('%02d', $i)] != 0) : ?>
										<?=$dblist[$g['company_idx']][$g['event_idx']][sprintf('%02d', $i)]?>
									<?php
									$temp_total += $dblist[$g['company_idx']][$g['event_idx']][sprintf('%02d', $i)];
										endif; 
									?>
									</td>
									<?php
