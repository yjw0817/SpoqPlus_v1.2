...
?>
<!-- Main content -->
<div class="new-title">판매상품(종목) 현황</div>
<section class="content">
        ...
        <div class="row" id='status-info'>
            <div class="col-lg-3 col-6">
                ...
                <h3><?php echo count($event_list)?><sup style="font-size: 20px"> 건</sup></h3>
                 <h6>판매 상품 수</h6>
                </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-6">
                ...
                <h3><?php echo number_format($paymt_sum[0]['sum_cost'])?><sup style="font-size: 20px"> 원</sup></h3>
                <h6>판매 상품 금액</h6>
                </div>
                </div>
            </div>
			...
			<div class="col-md-12">
                ...
                <div class="card card-primary">
    				...
    				<div class="card-header">
    					<h3 class="card-title">판매 상품 현황</h3>
    				</div>
    				<!-- CARD HEADER [END] -->
                        ...
                        <ul class="products-list product-list-in-card pl-2 pr-2">
                            ...
                            <li class="item" >
                                ...
                                <a href="javascript:void(0)" class="product-title">
                                	...
                                	if ($r['ACC_RTRCT_MTHD'] == '70') $badge_class = 'badge-info';
                                	?>
                                ...
                                <span class="product-description">
                                	<?php if($r['CLAS_DV'] == "21" || $r['CLAS_DV'] == "22" || $r['M_CATE'] == "PRV") :?>
                                ...
                                <?php if($r['EVENT_STAT_RSON'] == "00") :?>
                                    <?php echo $r['EXR_S_DATE']?> ~ <?php echo $r['EXR_E_DATE']?>
                                <?php else:?>
                                	<?php echo $r['EXR_S_DATE']?> ~ <?php echo date('Y-m-d', strtotime($r['MOD_DATETM'])) ?>
                                <?php endif;?>
                                </span>
