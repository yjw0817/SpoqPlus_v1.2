			...
			<div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="inputName">강사 이름 <span class="text-danger">*</span></label>
                            <input type="text" id="mem_nm" name="mem_nm" class="form-control" value="<?php echo $tinfo['MEM_NM']?>">
                        </div>
                        
                        <div class="form-group">
                            <label for="inputName">강사 생년월일 <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="inputName">강사 전화번호 <span class="text-danger">*</span></label>
...
function tmem_modify()
{
    ...
    if($("#bthday").val() == "")
    {
        alert("강사 생년월일을 입력해주세요.");
        $("#bthday").focus();
        return;
    }
    if($("#mem_telno").val() == "") 
    {
        alert("강사 전화번호를 입력해주세요.");
        $("#mem_telno").focus();
        return;
    }
