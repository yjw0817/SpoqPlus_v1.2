...
<!-- Main content -->
 <div class="new-title">출퇴근 QR코드</div>
<section class="content">
	<div class="container-fluid p-0">

		<div class="row">
			<div class="col-md-12">
				<div class='text-center size18 bold' style='margin-top:50px'>센터 입장 위한 QR 코드 입니다.</div>	
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div style='width:100%; text-align:center;'>
					<div id="qrcode" class='qrcode' style="margin:40px 0px;"></div>
				</div> 
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class='left size14' style='margin:10px'>
				ㆍ 위에 발급된 QR 코드는 시간 단위로 새롭게 갱신되어 발급되고 있습니다.<br /> 
				ㆍ 이전에 발급된 QR코드를 캡쳐해서 이용시 체크가 되지 않습니다. 이점 참고하시어 이용 하시기 바랍니다.
				</div>	
			</div>
		</div>
	</div>
...
<button type='button' class='btn btn-block bga-main pad20 ft-white mt20 radius0' onclick="temp_tattd();">임시 출근</button>
