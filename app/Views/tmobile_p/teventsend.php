...
?>
<!-- Main content -->
 <div class="new-title">보낸상품 현황</div>
<section class="content" id='sec1'>

	
	
        <div class="row" id='status-info'>
            <div class="col-lg-3 col-6" onclick="location.href='#sec1';">
            ...
            <div class="col-lg-3 col-6" onclick="location.href='#sec2';">
                ...
                <div class="card card-info">
                    ...
                    <div class="card-body p-0">
                        <ul class="products-list product-list-in-card pl-2 pr-2">
                            ...
                            <?php 
                            if ( count($event_list1) > 0 ) :
                            foreach ($event_list1 as $r) :
                            ...
                            switch($r['SEND_STAT'])
                            {
                                case "00" : // 대기
                                    ...
                                    break;
                                case "01" : // 결제
                                    $fcolor = "badge-success";
                                    break;
                                case "90" : // 만료
                                    $fcolor = "badge-danger";
                                    break;
                                case "99" : // 취소
                                    $fcolor = "badge-warning";
                                    break;
                            }
                            ...
                            <li class="item">
                                ...
                                <a href="javascript:void(0)" class="product-title">
                                	...
                                	<?php if ($r['SELL_AMT'] != $r['ORI_SELL_AMT']) :?>
                                ...
                                <span class="product-description">
                                	...
                                	<?php echo $r['CLAS_CNT']?>회 <span style="font-size:0.8rem;color:green">(<?php echo $r['MEM_NM']?> 회원님)</span>
                                	<?php else:?>
                                	<?php echo disp_produnit($r['USE_PROD'],$r['USE_UNIT'])?> <span style="font-size:0.8rem;color:green">(<?php echo $r['MEM_NM']?> 회원님)</span>
                                	<?php endif;?>
                                	<span class="badge badge-info float-right"><?php echo number_format($r['SELL_AMT']) ?></span>
                                </span>
                                <span class="badge <?php echo $fcolor?> float-right"><?php echo $sDef['SEND_STAT'][$r['SEND_STAT']]?></span>
                                <span style="font-size:0.8rem;color:red">
                                <?php echo $r['SEND_BUY_E_DATE']?>까지 구매가능
                                </span>
                                </div>
                            </li>
                        	<?php endforeach;
		...
		<div class="row  p-2"id='sec2'>
			<div class="col-md-12">
                ...
                <div class="card card-warning">
    				...
    				<!-- CARD HEADER [START] -->
    				<div class="card-header">
    					<h3 class="card-title">추천 구매 상품 현황</h3>
    				</div>
    				<!-- CARD HEADER [END] -->
                    ...
                    <div class="card-body p-0">
                        <ul class="products-list product-list-in-card pl-2 pr-2">
                            <?php 
                            if ( count($event_list2) > 0 ) :
                            foreach ($event_list2 as $r) :
