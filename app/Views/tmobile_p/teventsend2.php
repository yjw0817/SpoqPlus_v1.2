                        ...
                        <ul class="products-list product-list-in-card pl-2 pr-2">
                            <li class="item">
                                ...
                                <a href="javascript:void(0)" class="product-title">
                                	<span class="badge badge-success">입장무제한</span>
                                	헬스
                                ...
                                <span class="product-description">
                                	...
                                	<span class="badge badge-info float-right">250,000</span>
                                </span>
                            ...
                            <li class="item">
                                ...
                                <div class="product-info">
                                <a href="javascript:void(0)" class="product-title">
                                	<span class="badge badge-success">수업입장</span>
                                	PT
                                ...
                                <span class="product-description">
                                	PT 10회
                                	<span style="font-size:0.8rem;color:green">(이순신 4571)</span>
                                	<span class="badge badge-info float-right">1,000,000</span>
                                </span>
                                <span style="font-size:0.8rem;color:green">
                                3회 이용중
                                </span>
                            ...
                            <li class="item">
                                ...
                                <div class="product-info">
                                	<a href="javascript:void(0)" class="product-title">
                                    <span class="badge badge-danger">입장불가</span>
                                    락커
                                    </a>
                                <span class="product-description">
                                	락커 3개월
                                	<span style="font-size:0.8rem;color:green">(이순신 4571)</span>
                                	<span class="badge badge-info float-right">30,000</span>
                                </span>
                                <span style="font-size:0.8rem;color:green">
                                2024-05-01 ~ 2024-08-01
                                </span>
