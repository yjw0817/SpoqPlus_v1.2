...
?>
<!-- Main content -->
 <div class="new-title">종료(예정) 상품(종목)</div>
<section class="content">
		...
		<div class="row p-3">
			<div class="col-md-12">
				<div style='color:red;font-size:0.9rem;'>* 이용권 종료 예정은 이번달 말일까지 입니다.</div>
				<div style='color:red;font-size:0.9rem;'>* 수업종료 예정은 남은 수업일이 6회 이하일 경우입니다.</div>
			</div>
		</div>
			...
			<div class="col-md-12">
                ...
                <div class="card card-primary">
    				...
    				<div class="card-header">
    					<h3 class="card-title">종료 예정 수업 상품 현황</h3>
    				</div>
    				<!-- CARD HEADER [END] -->
                        ...
                        <ul class="products-list product-list-in-card pl-2 pr-2">
                            ...
                            <li class="item">
                                ...
                                <span class="product-description">
                                	...
                                	<span style='font-size:0.8rem;'>(<?php disp_mem_info($r['MEM_SNO'])?> <?php echo $r['MEM_NM']?> 회원님)</span>
				...
				<div class="card card-primary">
    				...
    				<!-- CARD HEADER [START] -->
    				<div class="card-header">
    					<h3 class="card-title">종료 예정 이용권 상품 현황</h3>
    				</div>
    				<!-- CARD HEADER [END] -->
