...
<div class="new-title">강사 공지사항</div>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<?php foreach ($list_notice as $r) :?>
                    <strong style="font-size:1rem;">ㆍ <?php echo $r['NOTI_TITLE']?></strong>
                    ...
                    <!-- <div class="text-muted" style="font-size:0.8rem;width:90%;white-space:nowrap; overflow: hidden; text-overflow:ellipsis;">
                        <?php echo $r['NOTI_CONTS']?>
                    </div> -->
                    <span style="display:block; font-size:0.8rem; padding-left:4px;"><i class="far fa-calendar-alt"></i>&nbsp; <?php echo $r['CRE_DATETM']?></span>
                    <hr>
                <?php endforeach;?>
	...
	jQuery.ajax({
        ...
        success: function (result) {
			...
			if (json_result['result'] == 'true')
			{
                ...
                var addHtml = "";				
                // addHtml = "<div class='bottom-title' style='padding-left:20px'>[ 강사 공지사항 ] </div>";
                addHtml += "<div class='col-12' style='padding:10px 20px'>";
                addHtml += "   <p class='lead bold'>"+ obj['NOTI_TITLE'] +"</p>";
                ...
                addHtml += "    </tr>";
                addHtml += "    <tr>";
                addHtml += "    <th class='' colspan='2'>내 용</th>";
                addHtml += "    </tr>";
                addHtml += "    <tr>";
                addHtml += "    <td class='' colspan='2'>"+ rn_br(obj['NOTI_CONTS']) +"</td>";
                addHtml += "    </tr>";
                addHtml += "    </table>";
                addHtml += "    </div>";
                addHtml += "</div>";
