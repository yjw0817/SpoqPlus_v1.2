...
?>
<!-- Main content -->
 <div class="new-title">GX수업현황</div>
<section class="content">
        ...
        <div class="row" id='status-info'>
            <div class="col-lg-3 col-6">
                ...
                <div class="inner">
                <h3><?php echo number_format($topinfo['get1'])?><sup style="font-size: 20px">회</sup></h3>
                <p>당월 수업전체 횟수</p>
                </div>
                </div>
            </div>
                        ...
                        <table class="table table-hover col-md-12" style='width:100%;'>
        					<tbody>
        						...
        						<tr class='' style='width:100%;'>
        							<td width='50px'><?php echo $chk_word?></td>
        							<td><?php echo $r['GX_CLAS_TITLE']?></td>
        							<td><?php echo $r['GX_CLAS_S_DATE']?><br />
        							<?php echo $r['GX_CLAS_S_HH_II']?> ~ <?php echo $r['GX_CLAS_E_HH_II']?>
        							<!-- 
...
<div class="overlay2">
    <div class="row"><div class="new-title">GX수업현황 검색</div>
    	<div class="col_md-12" style='width:100%'>
    		<div class="" id="bottom-menu-area">
    			<form name="form_tmem_payment" id="form_tmem_payment" method="post" action="/api/tmem_gxlist">
...
function btn_search()
{
	var sy = $('#ss_yy').val();
	var sm = $('#ss_mm').val();
	location.href="/api/tmem_gxlist/"+sy+"/"+sm;
}
