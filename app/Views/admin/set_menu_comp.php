		...
		<div class="col-xl-6">
			<div class="panel panel-inverse" >
				...
				<div class="panel-body">
					<div class="row mb-2">
						<label class="form-label col-form-label col-md-2">회사명:</label>
						<div class="col-md-3 ps-0">
							<input type="text" id="compNm" class="form-control enter">
						</div>
		...
		<div class="col-xl-6">
			<div class="panel panel-inverse" >
				<div class="panel-heading">
					...
					<div class="my-n1">
						<button id="btnSaveCompMenu" type="button" class="btn btn-primary btn-xs">저장</button>
					</div>
				</div>
				<!-- CARD BODY [START] -->
				<div class="panel-body">
...
<script>
	...
	$(document).ready(function() {
		...
		$("#btnSaveCompMenu").click(function(){ fnSaveCompMenu();})
		fnControlInit();
		fnGridList();
	...
	function fnGridList(nowPage) {
		...
		tblParam.compNm = $("#compNm").val();
		$.ajax({
			type: 'POST',
			url: '/adminmain/getCompList',
    		dataType:'json',
	...
	function fnGridListBind(jsonData){
        oTable = $('#grid').DataTable({
		    ...
		    "aoColumns":[ 
				  { "sTitle": "회사명", "mDataProp": "COMP_NM", "sWidth": "50%", "sClass": "cen", "bSortable": false }
    		 	, { "sTitle": "회사코드", "mDataProp": "COMP_CD", "sWidth": "30%", "sClass": "cen", "bSortable": false }
    		 	, { "sTitle": "회사 전화번호", "mDataProp": "COMP_TELNO", "sWidth": "10%", "sClass": "cen", "bSortable": false }
        ...
        $('#grid tbody').off('click').on( 'click', 'tr', function () {
            ...
            var data = oTable.row(this).data();
            fnMenuTreeList(data.COMP_CD);
            
        });
        
	}

	function fnMenuTreeList(compCd){
		var tblParam = {};
		tblParam.compCd = compCd;
		$.ajax({
			type: 'POST',
			url: '/adminmain/getMenuTreeListAtComp',
    		dataType:'json',
    		data:JSON.stringify(tblParam),
    		contentType:'application/json; charset=utf-8',
			async : false,
    ...
    function fnGetDelChkList(chkSels) {
    	...
    	chkSels.each(function (row) {
            ...
            var tblParam = {};
            tblParam.compCd = $tr.data("COMP_CD");
	...
	function fnSaveCompMenu() {
		...
		var url = '/adminmain/saveCompMenu';

		var tblParam = {};

		tblParam.compCd = data.COMP_CD;
		tblParam.compMenuList = fnGetSaveChkList();
