...
use Google\AuthHandler\Guzzle5AuthHandler;
use Google\AuthHandler\Guzzle6AuthHandler;
use Google\AuthHandler\Guzzle7AuthHandler;
use Google\Client;
 ...
 * the autoloader.
 */
class Google_Task_Composer extends Composer
{
}

if (false) {
  class Google_AccessToken_Revoke extends Revoke {}
  class Google_AccessToken_Verify extends Verify {}
  class Google_AuthHandler_AuthHandlerFactory extends AuthHandlerFactory {}
  class Google_AuthHandler_Guzzle5AuthHandler extends Guzzle5AuthHandler {}
  class Google_AuthHandler_Guzzle6AuthHandler extends Guzzle6AuthHandler {}
  class Google_AuthHandler_Guzzle7AuthHandler extends Guzzle7AuthHandler {}
  class Google_Client extends Client {}
  class Google_Collection extends Collection {}
  class Google_Exception extends \Google\Exception {}
  class Google_Http_Batch extends Batch {}
  class Google_Http_MediaFileUpload extends MediaFileUpload {}
  class Google_Http_REST extends REST {}
  class Google_Model extends Model {}
  class Google_Service extends Service {}
  class Google_Service_Exception extends \Google\Service\Exception {}
  class Google_Service_Resource extends Resource {}
  class Google_Task_Exception extends \Google\Task\Exception {}
  class Google_Task_Retryable extends Retryable {}
  class Google_Task_Runner extends Runner {}
  class Google_Utils_UriTemplate extends UriTemplate {}
}
